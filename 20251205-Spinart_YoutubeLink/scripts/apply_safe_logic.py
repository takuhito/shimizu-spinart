...
# The safe logic block to insert.
# Note: NO </mt:Else> tag.
# Note: regex_replace uses single quotes for attribute delimiters.
# Note: replacement string uses single quotes.
safe_logic = """<mt:Var name="video_raw" setvar="iframe_check" />
                                            <mt:If name="iframe_check" like="<iframe">
...
def apply_logic(content, col_num, suffix_type):
    ...
    # We look for the simplified version: <div ...>\n\s*<mt:Var name="video_raw" />\n\s*</div>
    ...
    def replacement_func(match):
        ...
        # Indent the logic for readability
        return f'{prefix}\n                                            {safe_logic}\n                                        {suffix}'
...
print("Applied safe video logic to Columns 01-05.")
